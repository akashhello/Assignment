...
#ifndef PROTOBUF_addressbook_2eproto_INCLUDED
#define PROTOBUF_addressbook_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::tutorial::AddressBook* Arena::Create< ::tutorial::AddressBook>(Arena*);
template<> ::tutorial::Person* Arena::Create< ::tutorial::Person>(Arena*);
template<> ::tutorial::Person_PhoneNumber* Arena::Create< ::tutorial::Person_PhoneNumber>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tutorial {
...
class Person_PhoneNumber : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Person.PhoneNumber) */ {
 public:
  ...
  inline Person_PhoneNumber* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Person_PhoneNumber>(NULL);
  }

  Person_PhoneNumber* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Person_PhoneNumber>(arena);
  }
...
class AddressBook : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.AddressBook) */ {
 public:
  ...
  inline AddressBook* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<AddressBook>(NULL);
  }

  AddressBook* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<AddressBook>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline ::google::protobuf::Timestamp* Person::mutable_last_updated() {
  ...
  if (last_updated_ == NULL) {
    last_updated_ = ::google::protobuf::Arena::CreateMessage< ::google::protobuf::Timestamp >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_addressbook_2eproto_INCLUDED
